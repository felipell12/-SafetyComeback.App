...
namespace SafetyComeback.App.Persistencia.Migrations
{
    ...
    [Migration("20211001162206_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafetyComeback.App.Dominio.Persona", b =>
                {
                    ...
                    b.Property<int?>("ProgramaId1")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ProgramaId1");
            ...
            modelBuilder.Entity("SafetyComeback.App.Dominio.Clase", b =>
                {
                    b.HasOne("SafetyComeback.App.Dominio.Clase", null)
                        .WithMany("Clases")
                        .HasForeignKey("ClaseId");

                    b.HasOne("SafetyComeback.App.Dominio.Programa", "Programas")
                        .WithMany()
                        .HasForeignKey("ProgramaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SafetyComeback.App.Dominio.Salon", "Salones")
                        .WithMany()
            ...
            modelBuilder.Entity("SafetyComeback.App.Dominio.Persona", b =>
                {
                    b.HasOne("SafetyComeback.App.Dominio.Programa", null)
                        .WithMany("Personas")
                        .HasForeignKey("ProgramaId1");
                });
